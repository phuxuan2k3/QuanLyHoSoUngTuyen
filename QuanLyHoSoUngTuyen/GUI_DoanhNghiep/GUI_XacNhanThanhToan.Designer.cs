namespace GUI.UC
{
	partial class GUI_XacNhanThanhToan
	{
		...
		private void InitializeComponent()
		{
			...
			tableLayoutPanel2.Size = new Size(823, 485);
			...
			tableLayoutPanel3.Location = new Point(3, 75);
			...
			tableLayoutPanel3.RowStyles.Add(new RowStyle(SizeType.Percent, 20F));
			tableLayoutPanel3.RowStyles.Add(new RowStyle());
			tableLayoutPanel3.Size = new Size(817, 407);
			...
			flowLayoutPanel1.Location = new Point(84, 41);
			flowLayoutPanel1.Name = "flowLayoutPanel1";
			flowLayoutPanel1.Size = new Size(258, 25);
			...
			flowLayoutPanel2.Location = new Point(84, 72);
			flowLayoutPanel2.Name = "flowLayoutPanel2";
			flowLayoutPanel2.Size = new Size(275, 25);
			...
			_hinhThucDangTuyen.Location = new Point(213, 0);
			_hinhThucDangTuyen.Name = "_hinhThucDangTuyen";
			_hinhThucDangTuyen.Size = new Size(59, 25);
			...
			flowLayoutPanel3.Location = new Point(84, 143);
			flowLayoutPanel3.Name = "flowLayoutPanel3";
			flowLayoutPanel3.Size = new Size(212, 28);
			...
			_tongChiPhi.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			label9.Location = new Point(84, 214);
			label9.Name = "label9";
			...
			tableLayoutPanel4.Location = new Point(84, 242);
			tableLayoutPanel4.Name = "tableLayoutPanel4";
			tableLayoutPanel4.RowCount = 1;
			tableLayoutPanel4.RowStyles.Add(new RowStyle());
			tableLayoutPanel4.Size = new Size(647, 77);
			...
			_cachThucThanhToan.Location = new Point(198, 3);
			_cachThucThanhToan.Name = "_cachThucThanhToan";
			_cachThucThanhToan.Size = new Size(259, 70);
			...
			_thanhToanThanhNhieuDot.Size = new Size(253, 29);
			...
			_thanhToanToanBo.Location = new Point(3, 38);
			_thanhToanToanBo.Name = "_thanhToanToanBo";
			_thanhToanToanBo.Size = new Size(190, 29);
			...
			tableLayoutPanel5.Location = new Point(481, 363);
