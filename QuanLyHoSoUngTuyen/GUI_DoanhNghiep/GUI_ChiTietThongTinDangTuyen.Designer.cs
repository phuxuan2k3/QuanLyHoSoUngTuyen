...
{
	partial class GUI_ChiTietThongTinDangTuyen
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			tableLayoutPanel1.Size = new Size(961, 463);
			...
			tableLayoutPanel2.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 40F));
			tableLayoutPanel2.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 10F));
			tableLayoutPanel2.Controls.Add(tableLayoutPanel6, 2, 8);
			...
			tableLayoutPanel2.Size = new Size(955, 388);
			...
			tableLayoutPanel6.Location = new Point(480, 262);
			...
			tableLayoutPanel6.Size = new Size(376, 123);
			tableLayoutPanel6.TabIndex = 6;
			// 
			// flowLayoutPanel11
			// 
			flowLayoutPanel11.Anchor = AnchorStyles.Right;
			...
			flowLayoutPanel11.Location = new Point(281, 63);
			...
			flowLayoutPanel1.Location = new Point(98, 45);
			...
			flowLayoutPanel2.Location = new Point(98, 76);
			...
			flowLayoutPanel9.Location = new Point(480, 107);
			flowLayoutPanel9.Name = "flowLayoutPanel9";
			flowLayoutPanel9.Size = new Size(279, 25);
			...
			label17.TabIndex = 0;
			label17.Text = "Tình trạng đăng tuyển:";
			// 
			// _tinhTrang
			// 
			_tinhTrang.AutoSize = true;
			_tinhTrang.Location = new Point(217, 0);
			...
			flowLayoutPanel8.Controls.Add(_trangThaiThanhToan);
			flowLayoutPanel8.Location = new Point(480, 76);
			flowLayoutPanel8.Name = "flowLayoutPanel8";
			flowLayoutPanel8.Size = new Size(269, 25);
			...
			label15.Size = new Size(198, 25);
			label15.TabIndex = 0;
			label15.Text = "Trạng thái thanh toán";
			// 
			// _trangThaiThanhToan
			// 
			_trangThaiThanhToan.AutoSize = true;
			_trangThaiThanhToan.Location = new Point(207, 0);
			...
			flowLayoutPanel5.Location = new Point(98, 169);
			flowLayoutPanel5.Name = "flowLayoutPanel5";
			flowLayoutPanel5.Size = new Size(162, 25);
			...
			_tenViTri.Location = new Point(100, 0);
			...
			flowLayoutPanel3.Location = new Point(98, 107);
			...
			flowLayoutPanel4.Location = new Point(98, 138);
			...
			flowLayoutPanel7.Location = new Point(480, 45);
			...
			tableLayoutPanel3.Location = new Point(98, 262);
			tableLayoutPanel3.Name = "tableLayoutPanel3";
			tableLayoutPanel3.RowCount = 3;
			tableLayoutPanel3.RowStyles.Add(new RowStyle(SizeType.Percent, 80F));
			tableLayoutPanel3.RowStyles.Add(new RowStyle());
			tableLayoutPanel3.RowStyles.Add(new RowStyle(SizeType.Percent, 20F));
			tableLayoutPanel3.Size = new Size(376, 123);
			...
			flowLayoutPanel10.Location = new Point(3, 63);
			...
			btnHieuChinh.Click += btnHieuChinh_Click;
			// 
			// flowLayoutPanel6
			// 
			...
			flowLayoutPanel6.Location = new Point(98, 200);
			flowLayoutPanel6.Name = "flowLayoutPanel6";
			flowLayoutPanel6.Size = new Size(164, 25);
			...
			_soLuong.Location = new Point(102, 0);
			...
			flowLayoutPanel12.Location = new Point(98, 231);
			flowLayoutPanel12.Name = "flowLayoutPanel12";
			flowLayoutPanel12.Size = new Size(153, 25);
			...
			_yeuCau.Location = new Point(91, 0);
